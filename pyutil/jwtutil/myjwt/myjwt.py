...
class MyJsonWebToken:
    ...
    def set_random_secret(self) -> MyJsonWebToken:
        """ランダムで秘密鍵をセットする"""
    ...
    def generate(self, paylaod: PayLoadDictionary) -> str:
        """トークン生成
        ヘッダを生成
        ペイロードを生成
        署名を生成する
...
def main():
    ...
    payload : PayLoadDictionary = {'user_id': 'value'}  # ユーザー情報,アルゴリズムなどが一般的。本番なら普通にクラスで定義する。
