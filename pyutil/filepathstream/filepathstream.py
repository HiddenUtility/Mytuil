...
from pyutil.filepathstream.path_stream import PathStream
from pyutil.filepathstream.xxx_filepath import XXXFilepath
...
class FilepathStream(PathStream):
    ...
    def _return(self,filepaths: list[XXXFilepath]) -> FilepathStream :
